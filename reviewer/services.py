...
def build_review_prompt(news_text: str, guidelines: Iterable[RetrievedChunk], examples: Iterable[RetrievedChunk]) -> List[dict]:
    ...
    user_prompt = (
        ...
        "   • يجب استبدال أي ذكر لـ 'مراسلنا' أو 'أفاد مراسلنا' أو 'أفادت مراسلتنا'\n"
        "   • ❌ خطأ: أفاد مراسلنا\n"
        "   • ✅ صحيح: أفاد مراسل يونا\n"
        "   • ✅ صحيح: أفاد مراسل قناة الغد\n"
        "   • ✅ صحيح: أفاد مراسل الوكالة\n\n"
    ...
    return [
        {
            ...
            "content": (
                ...
                "⛔ القاعدة 6: استبدال 'مراسلنا/مراسلتنا' بـ 'مراسل يونا' أو 'مراسل الوكالة' (إلزامي)\n"
