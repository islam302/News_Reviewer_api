...
def build_review_prompt(news_text: str, guidelines: Iterable[RetrievedChunk], examples: Iterable[RetrievedChunk]) -> List[dict]:
    ...
    user_prompt = (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        "🔴 ملاحظات عامة على معالج الأخبار - الحرص على تنفيذها! 🔴\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        "1. يجب أن يكون العنوان في سطر مستقل.\n"
        "2. يجب أن تكون كلمة (انتهى) في سطر مستقل.\n"
        "3. يجب أن يذكر المصدر اسم الوكالة بعد كلمة (يونا/…).\n"
        "4. يُفضّل ألا يتجاوز العنوان 12 كلمة.\n"
        "5. يُفضّل ألا يزيد عدد الكلمات في كل فقرة عن 50 كلمة، إلا إذا تطلب الخبر أكثر من ذلك.\n"
        "6. في حال وُجد في الخبر كلمات مثل: (وأفاد مراسلنا/ أفادت مراسلتنا) تُستبدل بالتالي (أفاد مراسل -ثم يُذكر اسم الوكالة-).\n"
        "7. يُفضّل التنويع في الأفعال الإعلامية داخل الخبر، مع استخدام كلمات منوعة مثل:\n"
        "   قال، ذكر، أوضح، أكد، شدّد، بيّن، أشار، أفاد، أعلن، أفصح، عبّر، أعرب، نوّه، أبان، كشف، لفت، رجّح، جزم، نفى،\n"
        "   أضاف، تابع، ختم، أورد، نقل، حدّد، دعا، طالب، حذّر، استنكر، ندّد، رحّب، أبدى، اعتبر، رأى، توقّع، أوصى، طرح،\n"
        "   أوعز، وجّه، استعرض، استدرك، استشهد، استوضح، استفسر، استبعد، استغرب، استخلص، استنتج، استحضر، استعاد،\n"
        "   صرّح، أخبر، أبلغ، أطلع، أبرز، أظهر، أحاط، أخطر، أقرّ، أيّد، أكّد مجدداً، جدّد التأكيد، شدّد مجدداً،\n"
        "   أعلن مجدداً، أوضح مجدداً، تابع القول، استكمل حديثه، أردف، أشار مجدداً.\n"
        "8. من المهم الحفاظ على تماسك الجمل وربطها بسلاسة عبر أدوات الربط المناسبة.\n"
        "9. في حال كان الخبر عن فلسطين لا نكتب كلمات مثل (مقتل أو مصرع أو موت) بل نكتب (استشهاد).\n"
        "10. في حالة وجود تاريخ يجب أن يُكتب بهذه الطريقة: الأحد 21 ديسمبر 2025م فقط،\n"
        "    لا نستخدم أسماء الشهور السريانية ولا الهجرية.\n"
        "11. تجنّب استخدام الصفات التقريرية (مثل: ضخم، غير مسبوق، تاريخي) إلا إذا كانت مدعومة ببيانات وأدلة.\n"
        "12. من المهم الحذر من الإفراط في استخدام الأقواس.\n"
        "13. ممنوع التكرار غير المبرر للجمل.\n"
        "14. من المهم الحرص والاهتمام بعلامات الترقيم (الفواصل والنقاط) - بنفس أهمية السلامة اللغوية من الأخطاء الإملائية.\n\n"
    ...
    return [
        {
            ...
            "content": (
                ...
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                "🔴 ملاحظات عامة على معالج الأخبار 🔴\n"
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                "1. يجب أن يكون العنوان في سطر مستقل.\n"
                "2. يجب أن تكون كلمة (انتهى) في سطر مستقل.\n"
                "3. يجب أن يذكر المصدر اسم الوكالة بعد كلمة (يونا/…).\n"
                "4. يُفضّل ألا يتجاوز العنوان 12 كلمة.\n"
                "5. يُفضّل ألا يزيد عدد الكلمات في كل فقرة عن 50 كلمة.\n"
                "6. استبدل (وأفاد مراسلنا/أفادت مراسلتنا) بـ (أفاد مراسل -اسم الوكالة-).\n"
                "7. نوّع في الأفعال الإعلامية: قال، ذكر، أوضح، أكد، شدّد، بيّن، أشار، أفاد، أعلن، أفصح، عبّر، أعرب، نوّه، أبان، كشف، لفت، رجّح، إلخ.\n"
                "8. حافظ على تماسك الجمل وربطها بأدوات الربط المناسبة.\n"
                "9. في أخبار فلسطين: استخدم (استشهاد) بدلاً من (مقتل/مصرع/موت).\n"
                "10. التاريخ يُكتب: الأحد 21 ديسمبر 2025م - بدون شهور سريانية أو هجرية.\n"
                "11. تجنّب الصفات التقريرية (ضخم، غير مسبوق، تاريخي) إلا إذا كانت مدعومة بأدلة.\n"
                "12. تجنّب الإفراط في استخدام الأقواس.\n"
                "13. ممنوع التكرار غير المبرر للجمل.\n"
                "14. الاهتمام بعلامات الترقيم (الفواصل والنقاط) بنفس أهمية الأخطاء الإملائية.\n\n"
